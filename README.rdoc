= AjaxValidationsForFormtastic

Marks invalid fields of semantic form, according to validation errors, received from server in JSON format.

== Installation

Simply add AjaxValidationsForFormtastic to your Gemfile and bundle it up:
  gem "formtastic_ajax_validations"
...
Bind validation to it:
  AjaxValidationForFormtastic $("#new_user"), "user", ["name", "email"]
